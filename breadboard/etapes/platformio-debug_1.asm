...
start:
        ...
        jmp     start           ; (jamais atteint: test_ram ne retourne pas, voir plus bas)
...
;
; Cette routine ne retourne jamais (elle boucle vers "start" a
; la fin) - c'est voulu: comme "call test_ram" laisse en
; permanence une adresse de retour tout en haut de la pile
; (physique 1FFFEh-1FFFFh), et que cette zone tombe justement
; dans la marge reservee ci-dessus, elle n'est jamais touchee ni
; requise.
; ============================================================
test_ram:
        ...
        call    blink
        jmp     start           ; recommence le test depuis le debut
