### Ce dossier contient un projet qui permet de tester un ROM Extra dans un environnement de simulation PC sous Bochs

---

## Afficher à l'écran en utilisant le tampon mémoire d'une carte VGA

<img src="../../medias/afficher_via_int21.png" alt="Alain Boudreault" width="500" />

### Traitements

* Fichier: extra_rom.asm
...
*Document rédigé par Alain Boudreault © 2026*  
